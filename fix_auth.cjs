...
// The original replacement made it invalid. Let's fix lines 291-330
// I will just read the file, find the google block, and replace it properly.
const googleBlockRegex = /\{\!adminMode && <div className="flex items-center my-5">[\s\S]*?<\/div>\}\<\/\>/;
